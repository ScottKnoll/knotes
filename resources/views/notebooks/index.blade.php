<x-layout>
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Notebooks
            </h2>
        </div>
                            ...
                            <tr>
                                <td class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-0">
                                    <a href="/notebooks/{{ $notebook->id }}"
                                        class="text-indigo-600 hover:text-indigo-700 hover:underline">{{ $notebook->name }}
                                    </a>
                                </td>
                                <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    {{ $notebook->created_at->format('M d, Y') }}</td>
                                <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
